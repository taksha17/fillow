...
export function heuristicAnswer(question, candidate, job = {}, prefs = {}, options = []) {
  ...
  if (isExportFollowUp) {
    ...
    if (/export control|citizen, national, or resident of any/i.test(q)) {
      return (
        pickApiOption(options, prefs.export_control_countries || "None/Not applicable")
  ...
  if (
    ...
    const loc = candidate.location || "Plano, TX, USA";
  ...
  if (
    ...
    return pickApiOption(options, loc)
      || pickApiOption(options, "Plano, TX")
      || pickApiOption(options, "Plano")
      || pickApiOption(options, "Texas")
      || loc;
  }
