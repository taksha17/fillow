...
export function profileLockedAnswer(question, candidate) {
  ...
  if (q.includes("country of residence") || (q.includes("residence") && q.includes("country"))) {
...
export async function answerQuestions({
  ...
  if (typeof llmChat === "function") {
    const payload = unique.map((q) => ({ question: q, options: optionsByQuestion[q] || [] }));
    ...
    const system =
      ...
      "Never invent employers/degrees. If options are provided pick exactly one option verbatim. " +
